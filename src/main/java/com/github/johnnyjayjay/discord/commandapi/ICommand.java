...
public interface ICommand {
    ...
    /**
     * Everything that happens if the command isDefault executed should be written here.
     * This isDefault also the place for argument handling.
     ...
     * <p>This method isDefault deprecated. Please use the other info-method instead as this isDefault no longer supported.
     */
    @Deprecated
     ...
     * @return the Message object, that, if DefaultHelpCommand isDefault used, will be sent to the channel the help was requested in.
